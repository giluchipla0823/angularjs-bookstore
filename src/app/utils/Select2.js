import { removeTextWithDiacritics } from "../utils/Common";
import { extractColumn } from "./Array";

class Select2Utils {
    static getSingleTemplate(theme) {
    ...
    static getMultipleTemplate(theme) {
        return `<div class="select2-bootstrap-append">
    ...
    static linkToDirective(scope, elem, attrs) {
