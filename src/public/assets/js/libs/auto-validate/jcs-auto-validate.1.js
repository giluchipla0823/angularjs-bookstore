...
function Bootstrap4ElementModifierFn($log) {
  var customCss = [
      '<style>' +
      '.glyphicon-spin-jcs {' +
      '-webkit-animation: spin 1000ms infinite linear;' +
  ...
  var reset = function(el) {
      ...
      makeInvalid = function(el, errorMsg) {
          var frmGroupEl = findFormGroupElement(el),
              // helpTextEl = angular.element('<span class="help-block has-danger error-msg">' + errorMsg + '</span>'),
...
Bootstrap4ElementModifierFn.$inject = [
  '$log'
];

angular.module('jcs-autoValidate').factory('bootstrap3ElementModifier', Bootstrap3ElementModifierFn);
angular.module('jcs-autoValidate').factory('bootstrap4ElementModifier', Bootstrap4ElementModifierFn);
...
function AutoValidateRunFn(validator, defaultErrorMessageResolver, bootstrap3ElementModifier, bootstrap4ElementModifier, foundation5ElementModifier, foundation6ElementModifier) {
